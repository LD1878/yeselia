...
const steps = [
  {
    ...
    text: {
      ...
      nl: "Locatie, schaal, budget, tijdlijn en leefstijleisen. Wij stellen vast wat essentieel is en wat flexibel is.",
    },
  },
  {
    title: {
    ...
    text: {
      ...
      nl: "U ontvangt alleen woningen die aan de briefing voldoen. Off-marketkansen worden opgenomen waar dat passend en beschikbaar is.",
    },
  },
  {
    title: {
    ...
    text: {
      ...
      nl: "Bezichtigingen worden efficiënt georganiseerd. Wij zijn aanwezig, adviseren en filteren in real time, zodat uw aandacht is voorbehouden aan serieuze kandidaten.",
    },
  },
  {
    title: {
    ...
    text: {
      ...
      nl: "Voor reservering of privécontract worden titel, stedenbouw, vergunningen, communitystatus en fiscale gevolgen onderzocht.",
    },
  },
  {
    title: {
    ...
    text: {
      ...
      nl: "Voorwaarden worden met juridische precisie onderhandeld. Waarborgstructuren, voorwaarden en termijnen worden opgesteld om uw positie te beschermen.",
    },
  },
  {
    title: {
    ...
    text: {
      ...
      nl: "Notariële levering, gelden en formaliteiten na levering worden als één ordelijke volgorde gecoördineerd.",
    },
  },
];
...
const guides = [
  {
    title: {
      ...
      nl: "Een woning kopen in Spanje: de essentiële checklist van een advocaat",
    },
  ...
  },
  {
    title: {
      ...
      nl: "Waarom een door een advocaat geleid kantoor de transactie verandert",
    },
  ...
  },
  {
    title: {
      ...
      nl: "Niet-ingezeten kopers: NIE, bankieren en logistiek van de levering",
    },
